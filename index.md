...
<section id="home">
    ...
    <div class="card" align="center">
        <img src="assets/uxlogo_r.png" width="100%" alt="Marllos Prado UX logo" />
    </div>
...
<section id="how-i-think">
    ...
    <div class="think-row">
        <img src="assets/logo_caregiver.png" class="think-img" alt="Caregiving icon" />
        <div class="think-text">
    ...
    <div class="think-row">
        <img src="assets/logo_cs.png" class="think-img" alt="Computer science icon" />
        <div class="think-text">
...
<section id="featured-work">
    ...
    <div class="grid-container">
        ...
        <div class="card">
            ...
            <p class="muted">A concept app connecting learners and volunteer mentors.</p>
        ...
        <div class="card">
            ...
            <p class="muted">Hands-on STEAM learning through creativity and play.</p>
        ...
        <div class="card">
            ...
            <p class="muted">UX-driven localization focused on clarity, tone, and cultural nuance.</p>
        ...
        <div class="card">
            ...
            <p class="muted">A self-initiated UX project exploring frictionless donation.</p>
